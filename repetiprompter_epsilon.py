...
#  main difference for 'epsilon' is temp increase per response, whcih is being done here:
...
def generate_chain(seed_prompt: str, chain_length: int, current_response: int, total_responses: int) -> List[Dict[str, Any]]:
    chain = [{"text": seed_prompt, "tokens": count_tokens(seed_prompt), "generation_time": 0, 'temp': BASE_TEMP}]  
